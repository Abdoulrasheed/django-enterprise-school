...
def student_required(function=None, redirect_field_name=REDIRECT_FIELD_NAME, login_url='login'):
    ...
    actual_decorator = user_passes_test(
        lambda u: u.is_active and u.groups.filter(name='student').exists() or u.is_superuser,
        login_url=login_url,
...
def teacher_required(function=None, redirect_field_name=REDIRECT_FIELD_NAME, login_url='login'):
    ...
    '''
    actual_decorator = user_passes_test(
        lambda u: u.is_active and u.groups.filter(name='teacher').exists() or u.is_superuser,
        login_url=login_url,
        redirect_field_name=redirect_field_name
    )
    if function:
...
def admin_required(function=None, redirect_field_name=REDIRECT_FIELD_NAME, login_url='login'):
    ...
    '''
    actual_decorator = user_passes_test(
        lambda u: u.is_active and u.groups.filter(name='admin').exists() or u.is_superuser,
        login_url=login_url,
        redirect_field_name=redirect_field_name
    )
    if function:
...
def parent_required(function=None, redirect_field_name=REDIRECT_FIELD_NAME, login_url='login'):
    ...
    '''
    actual_decorator = user_passes_test(
        lambda u: u.is_active and u.groups.filter(name='parent').exists() or u.is_superuser,
        login_url=login_url,
        redirect_field_name=redirect_field_name
    )
    if function:
