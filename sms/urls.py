...
urlpatterns = [
	...
	path('subject-allocation/', views.assign_teacher_list, name="assign_teacher_list"),
	path('subject-allocation-view-list/', views.assign_teacher_view, name="assign_teacher_view_list"),
	...
	path('view-score/', views.view_score, name="view_score_list"),
	...
	path('pages/', views.flatpage_list, name="pages"),
	path('delete_page/<int:page_id>/', views.delete_page, name="delete_page"),
	path('page/toogle/<int:page_id>/', views.toggle_page_restriction, name="toggle_page_restriction"),
